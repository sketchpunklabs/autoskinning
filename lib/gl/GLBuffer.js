...
export default class GLBuffer{
    ...
    read(){
        ...
        switch( this.dataType ){
            case WebGL2RenderingContext.FLOAT:
                cnt = this.compacity / 4;                       // How many floats available on GPU
                rtn = new Float32Array( this.compacity / 4 );   // Build F32 Array to hold byte data
                break;
            dafault:
                console.log( 'GLBuffer.read : Unknown DataType', this.dataType );
                return null;
        }
        ...
        gl.bindBuffer( this.type, this.ref );
        gl.getBufferSubData( this.type, 0, rtn, 0, cnt );
