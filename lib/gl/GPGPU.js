...
export default class GPGPU{
    ...
    static preCompute( sh, dt ){
        ...
        switch( status ){
            case 36053: break; // console.log( 'BufferStatus - Complete' ); 
            case 36054: console.log( 'BufferStatus - IncompleteAttachment' ); break;
            case 36057: console.log( 'BufferStatus - IncompleteDimensions' ); break;
            case 36055: console.log( 'BufferStatus - MissingAttachment' ); break;
            case 36061: console.log( 'BufferStatus - Unsupported' ); break;
            default: console.log( 'BufferStatus - Unknown : ', status ); break;
        }
    }
    ...
    static readUint32( dt ){
        ...
        // Read Data Out
        const results = new Uint32Array( dt.colLen * dt.rowLen * 4 );
        gl.readPixels( 0, 0, dt.colLen, dt.rowLen, gl.RGBA_INTEGER, gl.UNSIGNED_INT, results );
